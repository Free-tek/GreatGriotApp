...
public class EbookListByCategoriesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
    ...
    public EbookListByCategoriesViewHolder(View itemView) {
        super(itemView);
